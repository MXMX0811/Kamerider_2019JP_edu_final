...
class ObjectSearch(object):
    ...
    def set_params(self):
        ...
        self.sub_navigation_result_topic_name = rospy.get_param("sub_navigation_result_topic_name", "/kamerider_2/navi/output")
        self.sub_master_target_topic_name     = rospy.get_param("sub_master_target_topic_name", "/image/target")
        self.pub_search_result_topic_name     = rospy.get_param("pub_search_result_topic_name", "/kamerider_2/image/result")
